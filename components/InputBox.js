        ...
        <div className='bg-white p-2 rounded-2xl shadow-md text-gray-500 font-medium mt-6'>
            ...
            <div className="flex space-x-4 p-4 items-center">
                ...
                <form className='flex flex-1'>
                    <input type="text" placeholder={`What's on your mind, ${session.user.name}?`} className='rounded-full h-12 bg-gray-100 flex-grow px-5 focus:outline-none' ref={inputRef} />
